...
const BlogCard = ({ blog }) => {
  ...
  return (
    <div className="glass rounded-2xl p-6 hover:shadow-xl transition-all border-white/10 flex flex-col h-full opacity-0 translate-y-8">
      <div className="flex justify-between items-start mb-4">
        <span className={`text-[10px] uppercase tracking-widest font-bold px-2 py-1 rounded-md ${
          tag === 'LinkedIn' ? 'bg-blue-500/10 text-blue-500' : 'bg-accent-orange/10 text-accent-orange'
        }`}>
          {tag}
        </span>
